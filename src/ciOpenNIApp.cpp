...
void ciOpenNIAppApp::draw()
{
 ...
 //   Channel user0( 640, 480, 640, 1, usrImgDev0.get() );
    Channel depth0( 640, 480, 640, 1, imgRefDev1.get() );
 Surface8u color0( imgRefDev0.get(), 640, 480, 640*3, SurfaceChannelOrder::RGB );
// Surface8u color1( imgRefDev1.get(), 640, 480, 640*3, SurfaceChannelOrder::RGB );
 ...
 gl::draw( gl::Texture( color0 ), ci::Rectf( 0, 0, 640, 480 ));
 gl::draw( gl::Texture( depth0 ), ci::Rectf( 640, 0, 1280, 480 ));
